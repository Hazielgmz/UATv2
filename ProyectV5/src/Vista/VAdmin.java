...
public class VAdmin extends JFrame {
    ...
    public VAdmin() {
        ...
        JButton btnInventarioGeneral = crearBoton("Inventario General");
        JButton btnConsultasVentas = crearBoton("Consultas de Ventas");
        JButton btnReportes = crearBoton("Generar Reporte");
        JButton btnConfiguracion = crearBoton("Configuraci�n");
        ...
        panelBotones.add(btnInventarioGeneral);
        ...
        controlador.configurarListeners(btnCorteCaja, btnGestionProductos, btnInventarioGeneral, btnConsultasVentas, 
                                         btnReportes, btnConfiguracion, btnAyuda, btnSalir, btnGestionProveedores, btnDevoluciones);
