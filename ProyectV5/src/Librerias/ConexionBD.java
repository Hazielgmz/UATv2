...
public class ConexionBD {
    ...
    private static final String urlSQLServer = "jdbc:sqlserver://localhost:1433;databaseName=PosDB;encrypt=true;trustServerCertificate=true";
    private static final String usuarioSQLServer = "sa";
    private static final String passwordSQLServer = "3312";
