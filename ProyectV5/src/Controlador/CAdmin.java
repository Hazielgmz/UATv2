...
public class CAdmin {
    ...
    public void configurarMenu(JMenuBar menuBar) {
        ...
        JMenuItem miAlmacen = new JMenuItem("Almacén");
        JMenuItem miVenta = new JMenuItem("Venta");
        JMenuItem miReportes = new JMenuItem("Reportes");
        JMenuItem miProveedores = new JMenuItem("Gestión de Proveedores");
    ...
    private void abrirConfiguracion() {
        JOptionPane.showMessageDialog(vista, "Abrir Configuración");
    }
    ...
    private void abrirGestionProveedores() {
        JOptionPane.showMessageDialog(vista, "Abrir Gestión de Proveedores");
    }
    ...
    private void salir() {
        int confirm = JOptionPane.showConfirmDialog(vista, "¿Estás seguro de que quieres salir?", "Confirmación", JOptionPane.YES_NO_OPTION);
